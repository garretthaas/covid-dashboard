    ...
    .then(result => {
        ...
        //Positive Percentage 7-day average
          ...
          let changeNegPositive = parent.querySelector('[data-point="positive-percent-change"] .detail');
           console.log(changeNegPositive)
           console.log(printPrevDayPos)
        ...
        printCurrentHospitalizations.innerHTML = totalHospitalizedCurrent.toLocaleString();
          ...
          //@GH — can we use .toggle here?
            if (changeNegHospitalized.classList.contains('negative')) {
              ...
              printHospitalizationChange.innerHTML = hopitalizedChangeRollingAverage() + '%'
              console.log(hopitalizedChangeRollingAverage())
...
function blockCounty() {
  ...
  Object(_blockCountyDataPoint__WEBPACK_IMPORTED_MODULE_0__["getDataByPlaces"])("New York City");
  Object(_blockCountyDataPoint__WEBPACK_IMPORTED_MODULE_0__["getDataByPlaces"])("Collier");
  Object(_blockCountyDataPoint__WEBPACK_IMPORTED_MODULE_0__["getDataByPlaces"])("Hunterdon");
  Object(_blockCountyDataPoint__WEBPACK_IMPORTED_MODULE_0__["getDataByPlaces"])("Cook");
  ...
  Object(_visTrendLine__WEBPACK_IMPORTED_MODULE_1__["visTrendLine"])("https://coviddata.github.io/coviddata/v1/places/stats.json", "new-york-city-new-york-united-states", "cumulative", "cases");
  Object(_visTrendLine__WEBPACK_IMPORTED_MODULE_1__["visTrendLine"])("https://coviddata.github.io/coviddata/v1/places/stats.json", "new-york-city-new-york-united-states", "cumulative", "deaths");
  Object(_visTrendLine__WEBPACK_IMPORTED_MODULE_1__["visTrendLine"])("https://coviddata.github.io/coviddata/v1/places/stats.json", "collier-florida-united-states", "cumulative", "cases");
  Object(_visTrendLine__WEBPACK_IMPORTED_MODULE_1__["visTrendLine"])("https://coviddata.github.io/coviddata/v1/places/stats.json", "collier-florida-united-states", "cumulative", "deaths");
  Object(_visTrendLine__WEBPACK_IMPORTED_MODULE_1__["visTrendLine"])("https://coviddata.github.io/coviddata/v1/places/stats.json", "hunterdon-new-jersey-united-states", "cumulative", "cases");
  Object(_visTrendLine__WEBPACK_IMPORTED_MODULE_1__["visTrendLine"])("https://coviddata.github.io/coviddata/v1/places/stats.json", "hunterdon-new-jersey-united-states", "cumulative", "deaths");
  Object(_visTrendLine__WEBPACK_IMPORTED_MODULE_1__["visTrendLine"])("https://coviddata.github.io/coviddata/v1/places/stats.json", "cook-illinois-united-states", "cumulative", "cases");
  Object(_visTrendLine__WEBPACK_IMPORTED_MODULE_1__["visTrendLine"])("https://coviddata.github.io/coviddata/v1/places/stats.json", "cook-illinois-united-states", "cumulative", "deaths");
